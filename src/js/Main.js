...
var _user$project$AppCss$Clickable = {ctor: 'Clickable'};
...
var _user$project$AppCss$NiceShadow = {ctor: 'NiceShadow'};
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$AppCss$NiceShadow,
									{
										ctor: '::',
										_0: A4(
											...
											_rtfeldman$elm_css$Css$px(6),
											A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.16)),
										_1: {
											ctor: '::',
											_0: A4(
												_rtfeldman$elm_css$Css$boxShadow4,
												...
												_rtfeldman$elm_css$Css$px(6),
												_rtfeldman$elm_css$Css$px(6),
												A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.23)),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_0: A2(
																						_rtfeldman$elm_css$Css$class,
																						_user$project$AppCss$Clickable,
																						{
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$pointer),
																							_1: {ctor: '[]'}
		...
		var foodNames = _elm_lang$http$Http$jsonBody(
			_elm_lang$core$Json_Encode$list(
				A2(
					_elm_lang$core$List$map,
					function (food) {
						return _elm_lang$core$Json_Encode$string(food.id);
					},
					foods)));
...
var _user$project$Food_Api$getFood = F2(
	function (foodId, msg) {
		var url = A2(_elm_lang$core$Basics_ops['++'], 'api/food/', foodId);
		var request = A2(_elm_lang$http$Http$get, url, _user$project$Food_Api$decodeFood);
		return A2(_elm_lang$http$Http$send, msg, request);
	});

var _user$project$Food_Search$foodSearch = _elm_lang$core$Native_Platform.outgoingPort(
	'foodSearch',
	function (v) {
		return v;
	});
var _user$project$Food_Search$foodSearchResults = _elm_lang$core$Native_Platform.incomingPort(
	'foodSearchResults',
...
var _user$project$Nutrient_Models$NutrientFlag = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {id: a, name: b, description: c, dailyIntake: d, lowIntakeAmount: e, lowIntakeDescription: f, highIntakeAmount: g, highIntakeDescription: h, unitOfMeasure: i, nutrientType: j};
									};
								};
							};
						};
...
var _user$project$Nutrient_Models$nutrientFlagToNutrient = function (nutrientFlag) {
	var nutrientType = function () {
		var _p0 = nutrientFlag.nutrientType;
		switch (_p0) {
			case 'Vitamin':
				return _user$project$Nutrient_Models$Vitamin;
			case 'Mineral':
				return _user$project$Nutrient_Models$Mineral;
			default:
				return _user$project$Nutrient_Models$Vitamin;
		}
	}();
		...
		switch (_p15.ctor) {
			...
			case 'UpdateSearchText':
				...
				return (_elm_lang$core$String$isEmpty(
					...
					{
						ctor: '::',
						_0: _user$project$Food_Search$foodSearch(_p16),
						_1: {ctor: '[]'}
					});
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Food_Search$foodSearchResults(_user$project$Main$FoundFoods);
};
					...
					A2(
						...
						function (n) {
							return {
								ctor: '_Tuple2',
								_0: n.id,
								_1: _user$project$Nutrient_Models$nutrientFlagToNutrient(n)
							};
						},
						flags.nutrients)),
				...
				A2(
					...
					_elm_lang$core$Json_Decode$list(
						A2(
							...
							function (dailyIntake) {
								return A2(
									...
									function (description) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											function (highIntakeAmount) {
												return A2(
													_elm_lang$core$Json_Decode$andThen,
													function (highIntakeDescription) {
														return A2(
															_elm_lang$core$Json_Decode$andThen,
															function (id) {
																return A2(
																	_elm_lang$core$Json_Decode$andThen,
																	function (lowIntakeAmount) {
																		return A2(
																			_elm_lang$core$Json_Decode$andThen,
																			function (lowIntakeDescription) {
																				return A2(
																					_elm_lang$core$Json_Decode$andThen,
																					function (name) {
																						return A2(
																							_elm_lang$core$Json_Decode$andThen,
																							function (nutrientType) {
																								return A2(
																									_elm_lang$core$Json_Decode$andThen,
																									function (unitOfMeasure) {
																										return _elm_lang$core$Json_Decode$succeed(
																											{dailyIntake: dailyIntake, description: description, highIntakeAmount: highIntakeAmount, highIntakeDescription: highIntakeDescription, id: id, lowIntakeAmount: lowIntakeAmount, lowIntakeDescription: lowIntakeDescription, name: name, nutrientType: nutrientType, unitOfMeasure: unitOfMeasure});
																									},
																									A2(_elm_lang$core$Json_Decode$field, 'unitOfMeasure', _elm_lang$core$Json_Decode$string));
																							},
																							A2(_elm_lang$core$Json_Decode$field, 'nutrientType', _elm_lang$core$Json_Decode$string));
																					},
							...
							A2(_elm_lang$core$Json_Decode$field, 'dailyIntake', _elm_lang$core$Json_Decode$float)))));
		},
		A2(
			_elm_lang$core$Json_Decode$field,
			'foods',
